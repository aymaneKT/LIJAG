    ...
    <div>
      <div className="flex gap-2  items-center flex-wrap overflow-hidden max-[903px]:flex-wrap">
        <img
          loading="lazy"
          src={img3}
          className="max-w-full  h-auto grow w-[300px] min-w-[350px] object-cover object-center max-[500px]:object-center"
          alt="oficial-04906"
        />
        <img
          loading="lazy"
        ...
        <img
          loading="lazy"
          src={img2}
          className="max-w-full  h-auto grow w-[300px] min-w-[350px] object-cover object-center max-[500px]:object-center max-[903px]:aspec/normal  max-[1200px]:aspect-video"
          alt="DSC_6967"
        />
      </div>
